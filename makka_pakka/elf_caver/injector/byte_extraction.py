...
def extract_bytes(binary_filepath: str) -> str:
    ...
    :binary_filepath: The filepath string to the binary to extract bytes from.
    :returns: The bytes as a continuous string i.e "12 34 56..."
    """
...
def to_little_endian_32bit(value: int) -> Tuple[int, int, int, int]:
    ...
    if not isinstance(value, int):
        raise InvalidParameter("value", "to_little_endian_32bit", value)
